...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-hero-gradient flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-72 h-72 bg-primary-300/30 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-accent-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
        ...
        <div className="glass-card rounded-3xl shadow-card p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Sign in to continue to LuxeStay
            </p>
          </div>
